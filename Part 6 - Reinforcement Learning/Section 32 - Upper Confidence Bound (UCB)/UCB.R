  ...
  for(n in 1:N) {
    ...
    reward = dataset[n, ad] #reward at round n for specific ad
    sums_of_rewards[ad] = sums_of_rewards[ad] + reward
    total_reward = total_reward + reward
  }
  
  #total_reward for UCB = 2178
  
  # which ad is the best? ads_selected -> last ad = ads_selected[length(ads_selected)] = 5
  
  # Visualize the result
  
  hist(ads_selected,
       col = 'blue',
       main = 'Histogram of ads selections frequency',
       xlab = 'Ads',
